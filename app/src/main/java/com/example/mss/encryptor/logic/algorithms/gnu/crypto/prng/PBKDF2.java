...
import com.example.mss.encryptor.logic.algorithms.gnu.crypto.mac.HMac;
import com.example.mss.encryptor.logic.algorithms.gnu.crypto.mac.IMac;
...
public class PBKDF2 extends BasePRNG implements Cloneable {
   ...
   public Object clone() {
      PBKDF2 that = null;
      try {
         that = new PBKDF2((IMac) mac.clone());
